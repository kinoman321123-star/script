...
local function CreateSilentMenu()
    ...
    EnableToggle.Parent = Frame
    EnableToggle.BackgroundColor3 = Color3.fromRGB(255, 50, 50)
    EnableToggle.Position = UDim2.new(0.1, 0, 0, 60)
    EnableToggle.Size = UDim2.new(0.8, 0, 0, 35)
    EnableToggle.Font = Enum.Font.Gotham
    EnableToggle.Text = "Enable: OFF"
    ...
    EnableToggle.MouseButton1Click:Connect(function()
        ...
        EnableToggle.Text = "Enable: " .. (SilentAim.Enabled and "ON" or "OFF")
    end)
    
    -- Слайдер для Hitbox Size
    local HitboxLabel = Instance.new("TextLabel")
    HitboxLabel.Parent = Frame
    HitboxLabel.BackgroundTransparency = 1
    HitboxLabel.Position = UDim2.new(0.1, 0, 0, 110)
    HitboxLabel.Size = UDim2.new(0.8, 0, 0, 25)
    HitboxLabel.Font = Enum.Font.Gotham
    HitboxLabel.Text = "Hitbox Size: 10"
    ...
    HitboxSlider.BackgroundColor3 = Color3.fromRGB(55, 55, 55)
    HitboxSlider.Position = UDim2.new(0.1, 0, 0, 140)
    HitboxSlider.Size = UDim2.new(0.8, 0, 0, 8)
    
    local HitboxFill = Instance.new("Frame")
    HitboxFill.Parent = HitboxSlider
    HitboxFill.BackgroundColor3 = Color3.fromRGB(100, 150, 255)
    HitboxFill.BorderSizePixel = 0
    HitboxFill.Size = UDim2.new(0.2, 0, 1, 0)
    
    -- FOV Slider
    local FOVLabel = Instance.new("TextLabel")
    FOVLabel.Parent = Frame
    FOVLabel.BackgroundTransparency = 1
    FOVLabel.Position = UDim2.new(0.1, 0, 0, 165)
    FOVLabel.Size = UDim2.new(0.8, 0, 0, 25)
    ...
    FOVSlider.Position = UDim2.new(0.1, 0, 0, 195)
    FOVSlider.Size = UDim2.new(0.8, 0, 0, 8)
    ...
    TargetLabel.Position = UDim2.new(0.1, 0, 0, 220)
    ...
    TargetButton.BackgroundColor3 = Color3.fromRGB(55, 55, 55)
    TargetButton.Position = UDim2.new(0.1, 0, 0, 250)
    TargetButton.Size = UDim2.new(0.8, 0, 0, 35)
    ...
    TeamCheck.Position = UDim2.new(0.1, 0, 0, 300)
    TeamCheck.Size = UDim2.new(0.8, 0, 0, 35)
    ...
    CloseButton.Position = UDim2.new(0.1, 0, 0, 350)
    ...
    UIS.InputChanged:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseMovement then
            if draggingHitbox then
                ...
                SilentAim.HitboxSize = math.floor(percentage * 50)
                HitboxLabel.Text = "Hitbox Size: " .. SilentAim.HitboxSize
            end
            ...
            if draggingFOV then
                ...
                SilentAim.FOV = math.floor(percentage * 300)
                FOVLabel.Text = "FOV: " .. SilentAim.FOV
            end
        end
    end)
end
...
local function GetClosestPlayer()
    ...
    for _, player in pairs(Players:GetPlayers()) do
        if player ~= LocalPlayer then
            ...
            if character and character:FindFirstChild(SilentAim.TargetPart) then
...
oldNamecall = hookmetamethod(game, "__namecall", function(...)
    ...
    if SilentAim.Enabled and method == "FireServer" or method == "InvokeServer" then
        ...
        if closestPlayer and closestPlayer.Character then
            ...
            if targetPart then
                -- Модифицируем аргументы для попадания
...
-- Добавляем команду в систему команд
_G.Commands = _G.Commands or {}
_G.Commands["silent"] = function()
...
print("Part 7/7 - Silent Aim loaded!")
